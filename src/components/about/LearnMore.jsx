...
const LearnMore = () => {
  return (
    <div
      className="relative w-[1267px] h-[354px] bg-cover bg-center rounded-lg mt-[291px] mx-auto"
      style={{
    ...
    >
      ...
      <div className="absolute top-1/2 left-10 transform -translate-y-1/2 w-[542px] h-[249px] flex flex-col">
        ...
        {/* Button */}
        <button className="bg-[#5829EE] text-white text-[16px] font-medium py-[13px] px-[24px] rounded-[10px] mt-[59px] w-[138px] h-[56px] md:w-[180px] md:h-[60px] md:text-[18px]">
          Contact Us
        </button>
      </div>
    </div>
