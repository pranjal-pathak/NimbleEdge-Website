...
const NimbleEdgeSdk = () => {
  return (
    <div className="mt-[311px] flex flex-col items-center text-center">
      {/* Text Box 1 */}
      <div className="w-[924px] h-[65px]">
        <h1 className="font-generalSans text-[36px] font-semibold leading-[65px]">
          ...
          <span className="text-[#B6B6B6]">SDK</span>
        </h1>
      </div>
      ...
      <div className="w-[788px] h-[78px] mt-4">
        <p className="font-roboto text-[18px] leading-[160%] text-[#B6B6B6] font-light">
          Ultra lightweight SDK integrated with mobile app to enable on-device
          AI capabilities
        </p>
      </div>
    </div>
