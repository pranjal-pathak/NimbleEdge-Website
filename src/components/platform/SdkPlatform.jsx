...
const leftBoxData = [
  ...
  },
  {
    ...
    dropdownText:
      "Highly optimized and performant on-device GenAI \nexecution engine",
    dropdownText2:
      "Low-latency execution with minimal resource \nconsumption (e.g. RAM, Battery) across device models",
    lineStartGradient: "#4BBEFF",
    lineEndGradient: "#6565FF",
  },
];
          ...
          <div className="flex items-center" key={index}>
            ...
            {index < boxData.length - 1 && (
              <motion.img
                ...
                initial={{ opacity: 0.5 }}
                animate={{
                  opacity: selected === boxData[index + 1].name ? 1 : 0.5,
                }}
                transition={{ duration: 0.3 }}
              />
            )}
